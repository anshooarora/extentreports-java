...
public class DocumentConfig extends LogSettings {
	...
	public DocumentConfig chartTitle(Chart chart, String title) {
		...
		String currentTitle = ExtentMarkup.getPlaceHolder(chart.toString() + "chartTitle", "js", true) + ".*" + ExtentMarkup.getPlaceHolder(chart.toString() + "chartTitle", "js", true);
		String match = RegexMatcher.getNthMatch(html, currentTitle, 0);
		
		html = html.replace(match, ExtentMarkup.getPlaceHolder(chart.toString() + "chartTitle", "js", false) + "'" + title + "'" + ExtentMarkup.getPlaceHolder(chart.toString() + "chartTitle", "js", false));
